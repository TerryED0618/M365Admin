Function New-SecureCredentialPasswordFile {
	<#
		.SYNOPSIS
		...
		.NOTES
			...
			2023-04-04	Terry E Dow - Renamed function (and PS1 file) from New-SecureCredentialPassword[.ps1] to New-SecureCredentialPasswordFile[.ps1] for clarity.  
